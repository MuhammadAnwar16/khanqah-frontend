    ...
    <AnimatePresence>
      <motion.div
        ...
        className="fixed inset-0 z-50 flex items-center justify-center p-4 
                   bg-[#0C0C0C]/30 backdrop-blur-sm" // 🌟 Blur background
      >
        <motion.div
...
const FamilyTree = () => {
  ...
  const breadcrumbSchema = getBreadcrumbSchema([
    ...
    { name: isUrdu ? "شجرہ" : "Lineage", url: "/shajra" },
    { name: isUrdu ? "شجرہ نسب" : "Shajrah-e-Nasab", url: "/shajra" },
  ]);
...
/>
        ...
        <div className="relative z-10 max-w-7xl mx-auto mb-20 border-b border-gray-200 pb-8">
            ...
            `}>
                {language === "urdu" ? "شجرہ نسب" : "Shajra-e-Nasab"}
            </h2>
